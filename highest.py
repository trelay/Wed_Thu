...
for trade_date in df_2.index:
    ...
    if trade_time != "":
        ...
        lowest[trade_date] = int(tmp_time[0])+int(tmp_time[0])/60

after = lowest[lowest > 12]
morning = lowest[lowest < 12]

print("Totall found {} lowest on Wed.".format(lowest.count()))
print("lowest price happen {} times before 10:30 on the morning.".format(morning[morning<10.5].count()))
print("lowest price happen {} times after 10:30 on the morning.".format(morning[morning>10.5].count()))
print("lowest price happen {} times before 14:00 on the afternoon".format(after[after<14].count()))
print("lowest price happen {} times after 14:00 on the afternoon".format(after[after>14].count()))
